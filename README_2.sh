...
if [ $CELLLINE = "dr" ]; then
    BIN="/clustertmp/pooja/stageSpecificAnnotation/"$1""
    GBUILD="dr10"
    GET_ANNOTATION="FALSE"
    BOUT="/clustertmp/pooja/SLAMannotation/$CELLLINE/"$1"/output/"
...
###### i wrote another script that performs the addingIntergenicPeaks.R faster...
...
mkdir /groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/$1/
rsync -rva  --exclude "*.bam" --exclude "*.fastq" --exclude "*.fq" $BOUT/* /groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/$1/
