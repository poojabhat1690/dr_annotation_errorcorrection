...
/groups/ameres/Veronika/bin/slamdunk/bin/alleyoop utrrates -o /clustertmp/pooja/mapping_stageSpecificConuntingWindows_merged_includingPrimiRNA//utrRates/ -r /groups/ameres/bioinformatics/references/danio_rerio/dr10/danRer10.fa -mq 27 -b /groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/allStagesCombined/allAnnotations_withPriMirna.bed -l 88 "$i"
