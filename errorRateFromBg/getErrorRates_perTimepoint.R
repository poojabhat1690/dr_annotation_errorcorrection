### this is the scrript that corrects for SNPs and Bq for the untreated samples... 
...
sampleInfo = sampleInfo %>% filter(grepl(paste(c("Untre"), collapse="|"), V3))
...
for(i in 1:length(barcodesOfInterest)){
  ...
  infoSplit_interest =  paste0("/groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/slamDunk_combinedStageSpecific/filter/varSample_R1.vcf")
