...
vcf_R1 = read.table("/////groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/slamDunk_combinedStageSpecific/snp/combinedFile_CAAGCA.fastq.gz_adapterTrimmed_slamdunk_mapped_filtered_snp.vcf")
vcf_R2 = read.table("//////groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/slamDunk_combinedStageSpecific/snp/combinedFile_TAGGCT.fastq.gz_adapterTrimmed_slamdunk_mapped_filtered_snp.vcf")
vcf_R3 = read.table("///////groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/slamDunk_combinedStageSpecific/snp/combinedFile_ACGTCT.fastq.gz_adapterTrimmed_slamdunk_mapped_filtered_snp.vcf")
...
vectorizedsample = function(vcfFile,BamFile,countingWindows,barcode,condition){ 
  ...
  write.table(finalMatrix,paste0("////groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/probabilityOfFindingTC/zygoticTranscripts_vectorized/randomProbabilities/",barcode,condition,".txt"),sep="\t",quote = F)
...
vectorizedsample(vcfFile = vcfFile,BamFile = "/////groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/slamDunk_combinedStageSpecific/filter/out.bam",countingWindows = countingWindows_zygotic_gr,barcode = "all",condition = "combinedBam")
