...
refSeq_unmerged = read.table("/Volumes/groups/ameres/Pooja/Projects//zebrafishAnnotation/dr10/ensembl_dr10_Ensembl_Genes_88/proteinCoding_annotatedUTRs.bed",stringsAsFactors = F,sep="\t")
...
write.table(peaks_total_rearrange,"/Volumes//groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/stageSpecific/outputs/refseq/peaks_10_120bps.bed",sep="\t",quote = F,row.names = F,col.names = F)
